                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <?php 
                                        ...
                                        if ($result->num_rows > 0) {
                                          while($row = $result->fetch_assoc()) {
                                            $bill_id = $row["bill_id"];
                                        ?>
                              <div class="container mt-5" id="printable-div">
                                <div class="row">
                                  <div class="col-6">
                                  ...
                                  <div class="col-6 text-right">
                                     ...
                                     <span><b>Due Date:</b>  <u><?php echo (date("Y-m-d", strtotime($row["bDate"] . "+10 days")));?></u></span><br>
                                  </div>
                                </div>
                                <div class="row mt-4">
                                  <div class="col-12">
                              ...
                              <script>
                            function printDiv() {
                              var printableElement = document.getElementById("printable-div");
                            ...
                            <center> <button class = "btn btn-secondary" onclick="printDiv()">&nbsp;&nbsp;<i class="fas fa-solid fa-print"></i>&nbsp; &nbsp; Print&nbsp;&nbsp;</button> <button class = "btn btn-secondary yellow-btn" data-toggle="modal" data-target="#exampleModal">&nbsp;&nbsp;<i class="fas fa-solid fa-upload"></i>&nbsp; &nbsp; Upload Receipt&nbsp;&nbsp;</button></center> 
                            <?php 
